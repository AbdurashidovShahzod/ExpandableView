...
import kotlinx.android.synthetic.main.group_item_technical.view.*
import uz.unzosoft.expandableviewdemo.R

class MyExpandableAdapterTechnicals(
    ...
    override fun getGroupView(
        ...
        if (p2 == null) {
            groupItemView =
                LayoutInflater.from(p3?.context).inflate(R.layout.group_item_technical, p3, false)
        } else {
            groupItemView = p2
        }
        groupItemView.tvGroupTechnical.text = listTitle[groupPosition]
    ...
    override fun getChildView(
        ...
        if (convertView == null) {
            childItemView = LayoutInflater.from(parent?.context)
                .inflate(R.layout.child_item_technical, parent, false)
        } else {
